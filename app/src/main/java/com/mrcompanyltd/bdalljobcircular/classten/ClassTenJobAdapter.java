...
public class ClassTenJobAdapter extends RecyclerView.Adapter<ClassTenJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public ClassTenJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ClasstenjobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/classsscjob/classten_update.php?id=" + id1 + "&view=" + view1;
