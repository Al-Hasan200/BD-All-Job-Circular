...
public class ComputerJobAdapter extends RecyclerView.Adapter<ComputerJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public ComputerJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ComputerjobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/computerjob/computerjob_update.php?id=" + id1 + "&view=" + view1;
