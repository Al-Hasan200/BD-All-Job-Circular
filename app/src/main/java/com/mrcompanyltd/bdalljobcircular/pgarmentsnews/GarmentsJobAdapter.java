...
public class GarmentsJobAdapter extends RecyclerView.Adapter<GarmentsJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public GarmentsJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, GarmentsjobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/garmentsjob/garmentsjob_update.php?id=" + id1 + "&view=" + view1;
