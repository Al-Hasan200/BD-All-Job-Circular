...
public class EducationJobAdapter extends RecyclerView.Adapter<EducationJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public EducationJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, EducationjobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/educationjob/education_job_update.php?id=" + id1 + "&view=" + view1;
