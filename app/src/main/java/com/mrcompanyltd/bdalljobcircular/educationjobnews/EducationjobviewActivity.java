...
public class EducationjobviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_educationjobview);
    ...
    private void openPdfActivity(){
        jobCircularCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(new Intent(EducationjobviewActivity.this, EducationjobPdfviewActivity.class));
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(EducationjobviewActivity.this, EducationjobActivity.class));
                finish();
            }
        });
    }
