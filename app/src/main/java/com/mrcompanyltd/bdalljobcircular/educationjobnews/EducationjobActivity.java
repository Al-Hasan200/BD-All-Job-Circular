package com.mrcompanyltd.bdalljobcircular.educationjobnews;
...
public class EducationjobActivity extends AppCompatActivity {
    ...
    EducationJobAdapter educationJobAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_educationjob);

        //========== server data show in recyclerView code here ==========
        loadingAnimation = findViewById(R.id.loadingAnimation);
        recyclerView = findViewById(R.id.recyclerView);
        linearLayoutManager = new LinearLayoutManager(EducationjobActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        educationJobAdapter = new EducationJobAdapter(EducationjobActivity.this, arrayList);
        //myAdapter.notifyDataSetChanged();
        recyclerView.setAdapter(educationJobAdapter);
    ...
    private void loadGovtJobData() {
        ...
        String url = "https://spinier-worms.000webhostapp.com/bdjob/educationjob/education_job_view.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++){
                    try {
                        ...
                        educationJobAdapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EducationjobActivity.this, "চাকরির খবর লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(EducationjobActivity.this);
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(EducationjobActivity.this, JobnewsActivity.class));
                finish();
            }
        });
    }
