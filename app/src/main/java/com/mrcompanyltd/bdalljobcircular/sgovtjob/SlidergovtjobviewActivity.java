...
public class SlidergovtjobviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slidergovtjobview);
    ...
    private void openPdfActivity(){
        jobCircularCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(new Intent(SlidergovtjobviewActivity.this, SlidergovtjobPdfviewActivity.class));
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(SlidergovtjobviewActivity.this, SlidergovtjobActivity.class));
                finish();
            }
        });
    }
