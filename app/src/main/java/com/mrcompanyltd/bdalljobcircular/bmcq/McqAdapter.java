...
public class McqAdapter extends RecyclerView.Adapter<McqAdapter.JobViewHolder> {
    Context context;
    ArrayList<NewspaperModel> arrayList;
    int count = 0;

    public McqAdapter(Context context, ArrayList<NewspaperModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, McqPdfviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/mcq/mcq_update.php?id=" + id1 + "&view=" + view1;
