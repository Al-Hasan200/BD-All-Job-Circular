...
public class ItJobAdapter extends RecyclerView.Adapter<ItJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public ItJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ItjobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/itjob/itjob_update.php?id=" + id1 + "&view=" + view1;
