...
public class ClassEightJobAdapter extends RecyclerView.Adapter<ClassEightJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public ClassEightJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ClasseightjobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/classeightjob/classeight_update.php?id=" + id1 + "&view=" + view1;
