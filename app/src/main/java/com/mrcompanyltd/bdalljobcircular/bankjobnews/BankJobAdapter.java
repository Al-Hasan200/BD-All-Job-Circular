...
public class BankJobAdapter extends RecyclerView.Adapter<BankJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public BankJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, BankjobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/bankjob/bank_job_update.php?id=" + id1 + "&view=" + view1;
