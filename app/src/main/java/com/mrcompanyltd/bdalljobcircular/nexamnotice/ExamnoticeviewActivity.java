...
public class ExamnoticeviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_examnoticeview);
    ...
    private void setGovtJobData(){
        examNoticeTittle.setText("পরীক্ষার নোটিশঃ " + getIntent().getStringExtra("examNoticeTittle"));
        examNoticeDate.setText("পরীক্ষার তারিখঃ " + getIntent().getStringExtra("examNoticeDate"));
    ...
    private void openPdfActivity(){
        jobCircularCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(new Intent(ExamnoticeviewActivity.this, ExamnoticePdfviewActivity.class));
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(ExamnoticeviewActivity.this, ExamnoticeActivity.class));
                finish();
            }
        });
    }
