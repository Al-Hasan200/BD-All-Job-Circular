...
public class ExamnoticeActivity extends AppCompatActivity {
    ...
    ExamnoticeAdapter examnoticeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_examnotice);

        //========== server data show in recyclerView code here ==========
        loadingAnimation = findViewById(R.id.loadingAnimation);
        recyclerView = findViewById(R.id.recyclerView);
        linearLayoutManager = new LinearLayoutManager(ExamnoticeActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        examnoticeAdapter = new ExamnoticeAdapter(ExamnoticeActivity.this, arrayList);
        //myAdapter.notifyDataSetChanged();
        recyclerView.setAdapter(examnoticeAdapter);
    ...
    private void loadGovtJobData() {
        ...
        String url = "https://spinier-worms.000webhostapp.com/bdjob/examnotice/examnotice_view.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++){
                    try {
                        ...
                        String exam_notice_tittle = jsonObject.getString("exam_notice_tittle");
                        String exam_notice_date = jsonObject.getString("exam_notice_date");
                        String exam_notice_details = jsonObject.getString("exam_notice_details");
                        String exam_notice_source = jsonObject.getString("exam_notice_source");
                        ...
                        examnoticeAdapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ExamnoticeActivity.this, "নোটিশ লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(ExamnoticeActivity.this);
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(ExamnoticeActivity.this, NoticeActivity.class));
                finish();
            }
        });
    }
