...
public class ExamresultAdapter extends RecyclerView.Adapter<ExamresultAdapter.JobViewHolder> {
    Context context;
    ArrayList<ExamnoticeModel> arrayList;

    public ExamresultAdapter(Context context, ArrayList<ExamnoticeModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ExamresultviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/examresult/examresult_update.php?id=" + id1 + "&view=" + view1;
