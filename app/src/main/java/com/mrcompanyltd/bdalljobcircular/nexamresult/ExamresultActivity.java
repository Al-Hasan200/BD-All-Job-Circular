...
public class ExamresultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayoutManager = new LinearLayoutManager(ExamresultActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        examresultAdapter = new ExamresultAdapter(ExamresultActivity.this, arrayList);
    ...
    private void loadGovtJobData() {
        ...
        String url = "https://spinier-worms.000webhostapp.com/bdjob/examresult/examresult_view.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++){
                    try {
                        ...
                        String exam_notice_tittle = jsonObject.getString("exam_result_tittle");
                        String exam_notice_date = jsonObject.getString("exam_result_date");
                        String exam_notice_details = jsonObject.getString("exam_result_details");
                        String exam_notice_source = jsonObject.getString("exam_result_source");
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ExamresultActivity.this, "ফলাফল লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(ExamresultActivity.this, NoticeActivity.class));
                finish();
            }
        });
    }
