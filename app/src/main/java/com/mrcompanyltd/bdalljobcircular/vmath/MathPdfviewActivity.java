...
public class MathPdfviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mathpdfview);
        ...
        downloadCircularCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isStoragePermissionGranted()) {
                    ...
                    Toast.makeText(MathPdfviewActivity.this, "এমসিকিউ ডাউনলোড হচ্ছে...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                Intent intent = new Intent(MathPdfviewActivity.this, MathActivity.class);
