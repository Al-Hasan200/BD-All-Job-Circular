...
public class MathActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayoutManager = new LinearLayoutManager(MathActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        mathAdapter = new MathAdapter(MathActivity.this, arrayList);
    ...
    private void loadNewspaperData() {
        ...
        String url = "https://spinier-worms.000webhostapp.com/bdjob/math/math_view.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MathActivity.this, "এমসিকিউ লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(MathActivity.this);
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(MathActivity.this, TopicActivity.class));
                finish();
            }
        });
    }
