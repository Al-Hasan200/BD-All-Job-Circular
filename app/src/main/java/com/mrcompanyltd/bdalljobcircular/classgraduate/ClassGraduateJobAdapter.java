...
public class ClassGraduateJobAdapter extends RecyclerView.Adapter<ClassGraduateJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public ClassGraduateJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ClassgraduatejobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/classgraduatejob/classgraduate_update.php?id=" + id1 + "&view=" + view1;
