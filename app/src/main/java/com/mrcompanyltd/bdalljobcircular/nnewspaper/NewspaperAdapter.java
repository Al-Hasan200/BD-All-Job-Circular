...
public class NewspaperAdapter extends RecyclerView.Adapter<NewspaperAdapter.JobViewHolder> {
    Context context;
    ArrayList<NewspaperModel> arrayList;
    int count = 0;

    public NewspaperAdapter(Context context, ArrayList<NewspaperModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, NewspaperPdfviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/newspaper/newspaper_update.php?id=" + id1 + "&view=" + view1;
