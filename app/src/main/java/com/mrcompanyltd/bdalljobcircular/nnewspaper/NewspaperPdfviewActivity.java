package com.mrcompanyltd.bdalljobcircular.nnewspaper;
...
import com.mrcompanyltd.bdalljobcircular.ngojobnews.NgojobviewActivity;
...
public class NewspaperPdfviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_newspaperpdfview);
        ...
        String newsTitle = getIntent().getExtras().getString("tittle", "defaultKey");
        ...
        downloadCircularCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isStoragePermissionGranted()) {
                    ...
                    request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "BD All Job Circular/" + newsTitle + ".pdf");
                    DownloadManager downloadManager = (DownloadManager) getSystemService(DOWNLOAD_SERVICE);
                    downloadManager.enqueue(request);
                    registerReceiver(onComplete, new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE));
                    Toast.makeText(NewspaperPdfviewActivity.this, "পত্রিকা ডাউনলোড হচ্ছে...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                Intent intent = new Intent(NewspaperPdfviewActivity.this, NewspaperActivity.class);
    ...
    BroadcastReceiver onComplete=new BroadcastReceiver() {
        public void onReceive(Context ctxt, Intent intent) {
            // your code
            Toast.makeText(ctxt, "পত্রিকা ডাউনলোড সম্পন্ন হয়েছে...", Toast.LENGTH_SHORT).show();
        }
    };
}