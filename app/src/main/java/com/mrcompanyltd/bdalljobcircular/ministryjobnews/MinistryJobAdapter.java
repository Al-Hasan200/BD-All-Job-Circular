...
public class MinistryJobAdapter extends RecyclerView.Adapter<MinistryJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public MinistryJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, MinistryjobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/ministryjob/ministry_job_update.php?id=" + id1 + "&view=" + view1;
