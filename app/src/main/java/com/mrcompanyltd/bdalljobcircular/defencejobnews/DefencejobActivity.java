package com.mrcompanyltd.bdalljobcircular.defencejobnews;
...
public class DefencejobActivity extends AppCompatActivity {
    ...
    DefenceJobAdapter defenceJobAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_defencejob);

        //========== server data show in recyclerView code here ==========
        loadingAnimation = findViewById(R.id.loadingAnimation);
        recyclerView = findViewById(R.id.recyclerView);
        linearLayoutManager = new LinearLayoutManager(DefencejobActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        defenceJobAdapter = new DefenceJobAdapter(DefencejobActivity.this, arrayList);
        //myAdapter.notifyDataSetChanged();
        recyclerView.setAdapter(defenceJobAdapter);
    ...
    private void loadGovtJobData() {
        ...
        String url = "https://spinier-worms.000webhostapp.com/bdjob/defencejob/defence_job_view.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++){
                    try {
                        ...
                        defenceJobAdapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DefencejobActivity.this, "চাকরির খবর লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(DefencejobActivity.this);
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(DefencejobActivity.this, JobnewsActivity.class));
                finish();
            }
        });
    }
