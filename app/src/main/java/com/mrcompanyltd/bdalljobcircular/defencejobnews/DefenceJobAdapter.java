...
public class DefenceJobAdapter extends RecyclerView.Adapter<DefenceJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public DefenceJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DefencejobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/defencejob/defence_job_update.php?id=" + id1 + "&view=" + view1;
