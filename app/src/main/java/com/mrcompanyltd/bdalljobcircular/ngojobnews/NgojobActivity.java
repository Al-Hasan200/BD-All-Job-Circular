package com.mrcompanyltd.bdalljobcircular.ngojobnews;
...
public class NgojobActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayoutManager = new LinearLayoutManager(NgojobActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        ngoJobAdapter = new NgoJobAdapter(NgojobActivity.this, arrayList);
        //myAdapter.notifyDataSetChanged();
        recyclerView.setAdapter(ngoJobAdapter);
    ...
    private void loadGovtJobData() {
        ...
        String url = "https://spinier-worms.000webhostapp.com/bdjob/ngojob/ngo_job_view.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++){
                    try {
                        ...
                        ngoJobAdapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(NgojobActivity.this, "চাকরির খবর লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(NgojobActivity.this);
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(NgojobActivity.this, JobnewsActivity.class));
                finish();
            }
        });
    }
