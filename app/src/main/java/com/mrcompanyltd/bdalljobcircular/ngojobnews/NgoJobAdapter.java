...
public class NgoJobAdapter extends RecyclerView.Adapter<NgoJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public NgoJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, NgojobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/ngojob/njo_job_update.php?id=" + id1 + "&view=" + view1;
