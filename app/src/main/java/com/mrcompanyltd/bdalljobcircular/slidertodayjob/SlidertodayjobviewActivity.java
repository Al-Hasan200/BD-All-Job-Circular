...
public class SlidertodayjobviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slidertodayjobview);
    ...
    private void openPdfActivity(){
        jobCircularCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(new Intent(SlidertodayjobviewActivity.this, SlidertodayjobPdfviewActivity.class));
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(SlidertodayjobviewActivity.this, SlidertodayjobActivity.class));
                finish();
            }
        });
    }
