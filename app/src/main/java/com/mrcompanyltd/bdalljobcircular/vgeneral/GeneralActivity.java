...
public class GeneralActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayoutManager = new LinearLayoutManager(GeneralActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        generalAdapter = new GeneralAdapter(GeneralActivity.this, arrayList);
    ...
    private void loadNewspaperData() {
        ...
        String url = "https://spinier-worms.000webhostapp.com/bdjob/general/general_view.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(GeneralActivity.this, "এমসিকিউ লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(GeneralActivity.this, TopicActivity.class));
                finish();
            }
        });
    }
