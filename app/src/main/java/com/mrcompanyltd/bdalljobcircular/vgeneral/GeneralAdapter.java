...
public class GeneralAdapter extends RecyclerView.Adapter<GeneralAdapter.JobViewHolder> {
    Context context;
    ArrayList<NewspaperModel> arrayList;
    int count = 0;

    public GeneralAdapter(Context context, ArrayList<NewspaperModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, GeneralPdfviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/general/general_update.php?id=" + id1 + "&view=" + view1;
