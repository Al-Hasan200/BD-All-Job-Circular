...
public class NnoticeviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nnoticeview);
    ...
    private void setGovtJobData(){
        examNoticeTittle.setText("নোটিশঃ " + getIntent().getStringExtra("examNoticeTittle"));
    ...
    private void openPdfActivity(){
        jobCircularCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(new Intent(NnoticeviewActivity.this, NnoticePdfviewActivity.class));
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(NnoticeviewActivity.this, NnoticeActivity.class));
                finish();
            }
        });
    }
