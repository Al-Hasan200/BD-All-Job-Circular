package com.mrcompanyltd.bdalljobcircular.sliderprivatejob;
...
import com.mrcompanyltd.bdalljobcircular.activity.MainActivity;
...
public class SliderprivatejobActivity extends AppCompatActivity {
    ...
    SliderprivateJobAdapter sliderprivateJobAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sliderprivatejob);

        //========== server data show in recyclerView code here ==========
        loadingAnimation = findViewById(R.id.loadingAnimation);
        recyclerView = findViewById(R.id.recyclerView);
        linearLayoutManager = new LinearLayoutManager(SliderprivatejobActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        sliderprivateJobAdapter = new SliderprivateJobAdapter(SliderprivatejobActivity.this, arrayList);
        //myAdapter.notifyDataSetChanged();
        recyclerView.setAdapter(sliderprivateJobAdapter);
        //========== load today job data method call here ==========
        loadTodayJobData();
    ...
    //========== load today job data method code here ==========
    private void loadTodayJobData() {
        loadingAnimation.setVisibility(View.VISIBLE);
        loadingAnimation.playAnimation();

        String url = "https://spinier-worms.000webhostapp.com/bdjob/privatejob/private_job_view.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++){
                    try {
                        ...
                        sliderprivateJobAdapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(SliderprivatejobActivity.this, "চাকরির খবর লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(SliderprivatejobActivity.this);
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(SliderprivatejobActivity.this, MainActivity.class));
                finish();
            }
        });
    }
