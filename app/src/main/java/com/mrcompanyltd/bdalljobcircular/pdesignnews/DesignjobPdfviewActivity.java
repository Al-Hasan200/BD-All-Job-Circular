...
public class DesignjobPdfviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_designjobpdfview);
        ...
        downloadCircularCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isStoragePermissionGranted()) {
                    ...
                    Toast.makeText(DesignjobPdfviewActivity.this, "সার্কুলার ডাউনলোড হচ্ছে...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                Intent intent = new Intent(DesignjobPdfviewActivity.this, DesignjobviewActivity.class);
