...
import com.mrcompanyltd.bdalljobcircular.todayjobnews.TodayjobPdfviewActivity;
import com.mrcompanyltd.bdalljobcircular.todayjobnews.TodayjobviewActivity;
...
public class GovtjobPdfviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_govtjobpdfview);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                new GovtjobPdfviewActivity.Retrivepdf().execute(pdf);
            }
        }, 2000);
        ...
        downloadCircularCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isStoragePermissionGranted()) {
                    ...
                    Toast.makeText(GovtjobPdfviewActivity.this, "সার্কুলার ডাউনলোড হচ্ছে...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                Intent intent = new Intent(GovtjobPdfviewActivity.this, GovtjobviewActivity.class);
    ...
    BroadcastReceiver onComplete=new BroadcastReceiver() {
        public void onReceive(Context ctxt, Intent intent) {
            // your code
            Toast.makeText(ctxt, "সার্কুলার ডাউনলোড সম্পন্ন হয়েছে...", Toast.LENGTH_SHORT).show();
        }
    };
}