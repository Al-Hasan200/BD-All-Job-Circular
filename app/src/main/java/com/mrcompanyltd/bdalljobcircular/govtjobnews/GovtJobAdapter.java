...
public class GovtJobAdapter extends RecyclerView.Adapter<GovtJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public GovtJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, GovtjobviewActivity.class);
