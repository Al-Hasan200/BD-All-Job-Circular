package com.mrcompanyltd.bdalljobcircular.privatejobnews;
...
public class PrivatejobActivity extends AppCompatActivity {
    ...
    PrivateJobAdapter privateJobAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_privatejob);

        //========== server data show in recyclerView code here ==========
        loadingAnimation = findViewById(R.id.loadingAnimation);
        recyclerView = findViewById(R.id.recyclerView);
        linearLayoutManager = new LinearLayoutManager(PrivatejobActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        privateJobAdapter = new PrivateJobAdapter(PrivatejobActivity.this, arrayList);
    ...
    private void loadGovtJobData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++){
                    try {
                        ...
                        privateJobAdapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PrivatejobActivity.this, "চাকরির খবর লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(PrivatejobActivity.this);
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(PrivatejobActivity.this, JobnewsActivity.class));
                finish();
            }
        });
    }
