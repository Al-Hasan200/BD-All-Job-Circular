...
public class PrivateJobAdapter extends RecyclerView.Adapter<PrivateJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public PrivateJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, PrivatejobviewActivity.class);
