package com.mrcompanyltd.bdalljobcircular.classhsc;
...
public class ClasshscjobActivity extends AppCompatActivity {
    ...
    ClassHscJobAdapter classHscJobAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hscjob);

        //========== server data show in recyclerView code here ==========
        loadingAnimation = findViewById(R.id.loadingAnimation);
        recyclerView = findViewById(R.id.recyclerView);
        linearLayoutManager = new LinearLayoutManager(ClasshscjobActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        classHscJobAdapter = new ClassHscJobAdapter(ClasshscjobActivity.this, arrayList);
        //myAdapter.notifyDataSetChanged();
        recyclerView.setAdapter(classHscJobAdapter);
    ...
    private void loadGovtJobData() {
        ...
        String url = "https://spinier-worms.000webhostapp.com/bdjob/classhscjob/classhsc_job_view.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++){
                    try {
                        ...
                        classHscJobAdapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ClasshscjobActivity.this, "চাকরির খবর লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(ClasshscjobActivity.this);
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(ClasshscjobActivity.this, QualificationActivity.class));
                finish();
            }
        });
    }
