...
public class ClassHscJobAdapter extends RecyclerView.Adapter<ClassHscJobAdapter.JobViewHolder> {
    Context context;
    ArrayList<JobModel> arrayList;

    public ClassHscJobAdapter(Context context, ArrayList<JobModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ClasshscjobviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/classhscjob/classhsc_update.php?id=" + id1 + "&view=" + view1;
