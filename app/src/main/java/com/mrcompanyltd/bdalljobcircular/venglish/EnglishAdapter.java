...
public class EnglishAdapter extends RecyclerView.Adapter<EnglishAdapter.JobViewHolder> {
    Context context;
    ArrayList<NewspaperModel> arrayList;
    int count = 0;

    public EnglishAdapter(Context context, ArrayList<NewspaperModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, EnglishPdfviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/english/english_update.php?id=" + id1 + "&view=" + view1;
