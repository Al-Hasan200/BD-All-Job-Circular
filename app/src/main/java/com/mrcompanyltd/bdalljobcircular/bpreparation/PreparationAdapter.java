...
public class PreparationAdapter extends RecyclerView.Adapter<PreparationAdapter.JobViewHolder> {
    Context context;
    ArrayList<NewspaperModel> arrayList;
    int count = 0;

    public PreparationAdapter(Context context, ArrayList<NewspaperModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, PreparationPdfviewActivity.class);
                ...
                String url = "https://spinier-worms.000webhostapp.com/bdjob/allpreparation/preparation_update.php?id=" + id1 + "&view=" + view1;
