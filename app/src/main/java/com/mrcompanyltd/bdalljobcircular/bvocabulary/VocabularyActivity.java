...
public class VocabularyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayoutManager = new LinearLayoutManager(VocabularyActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        arrayList = new ArrayList<>();
        vocabularyAdapter = new VocabularyAdapter(VocabularyActivity.this, arrayList);
    ...
    private void loadNewspaperData() {
        ...
        String url = "https://spinier-worms.000webhostapp.com/bdjob/vocabulary/vocabulary_view.php";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(VocabularyActivity.this, "ভোকাবুলারি লোড হতে সমস্যা হচ্ছে...", Toast.LENGTH_SHORT).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(VocabularyActivity.this);
    ...
    private void backButtonClick(){
        backArrowJobView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound();
                startActivity(new Intent(VocabularyActivity.this, PreparationActivity.class));
                finish();
            }
        });
    }
